...
function projects() {
    ...
    $('.luvtalk-project h3').css(
        ...
        ($('.luvtalk-project').height() -
            ...
            $('.luvtalk-project .row').outerHeight()) / 2
    );
    ...
    $('.strike-zone-project h3').css(
        ...
        ($('.strike-zone-project').height() -
            ...
            $('.strike-zone-project .row').outerHeight()) / 2
    );
    var doit;
                ...
                <div className="row">
                    <div className="col-sm-4 col-md-4 text-center">
                        <div className="luvtalk-project">
                            ...
                            <p>Website, created during my first internship, which utilized HTML, CSS, PHP, Ajax,
                                Javascript/jQuery, and Wordpress. </p>
                            <div className="row">
                    ...
                    <div className="col-sm-4 col-md-4 text-center">
                        <div className="personal-website-project">
                            ...
                            <p>Enjoyable side project that was created to experiment with more HTML and CSS, but also
                                provided an outlet to showcase my abilities and interests.</p>
                            <div className="row">
                                <div className="col-sm-4 col-md-4 col-sm-offset-4 col-md-offset-4">
                                    <div className="project-more-info">
                                        <a className="btn btn-default btn-border" href="#">More</a>
                    ...
                    <div className="col-sm-4 col-md-4 text-center">
                        <div className="strike-zone-project">
                            ...
                            <p>Data analytics project completed during my time at the Illinois Math and Science Academy
                                which studied the baseball strike zone based on the state of the game.</p>
                            <div className="row">
                                <div className="col-sm-4 col-md-4 col-sm-offset-4 col-md-offset-4">
                                    <div className="project-more-info">
                                        <a className="btn btn-default btn-border" href="#">More</a>
